...
<html>
   ...
   <u><b><font size="30px" face="courier" color="darkred" style="font-size: 30px" ><center>CRIME INVESTIGATION</center></font></u></b>
        ...
        <table border="1">
            <tr><td>SID</td><td>WEIGHT</td><td>RACE</td><td>GENDER</td><td>ACTUAL HEIGHT</td><td>PREDICTED HEIGHT</td><td>ERRROR</td><td>ERRROR %</td></tr>
...
out.println("<tr><td>"+(i+1)+"</td><td>"+wt+"</td><td>"+r+"</td><td>"+g+"</td><td>"+hch+"</td><td>"+ch+"</td><td>"+err+"</td><td>"+errp+"</td></tr>");
...
err=(h-o);
errp=Math.abs(err)*100;
out.println("<tr><td>"+i+"</td><td>"+wt+"</td><td>"+r+"</td><td>"+g+"</td><td>"+hch+"</td><td>"+ch+"</td><td>"+err+"</td><td>");%><font color="red"><%out.println(errp);%></font><%out.println("</td></tr>");
