<%-- 
    Document   : crime
    Created on : Apr 23, 2012, 3:22:32 PM
    Author     : Nikita
--%>
...
<html>
   ...
   <u><b><font size="30px" face="courier" color="darkred" style="font-size: 30px" ><center>CRIME INVESTIGATION</center></font></u></b>
        ...
        <center><h2>CRIME ANALYSIS</h2></center>
        <table>

            <tr><td><a href="">CRIME DATA</a></td></tr>
            <tr><td><a href="">VIEW CLUSTER</a></td></tr>
            <tr><td><a href="">HOTSPOTS</a></td></tr>
            <tr><td><a href="">INFORMATION RETRIEVAL</a></td></tr>
            <tr><td><a href="AssociationCrime.jsp">CRIME PATTERN DETECTION AND ANALYSIS</a></td></tr>
        </table>
    </body>
</html>
