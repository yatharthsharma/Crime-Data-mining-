...
<html>
   ...
   <u><b><font size="30px" face="courier" color="darkred" style="font-size: 30px" ><center>CRIME INVESTIGATION</center></font></u></b>
        ...
        <table border="1">
            <tr><td>SID</td><td>WEIGHT</td><td>HEIGHT</td><td>GENDER</td><td>ACTUAL RACE</td><td>PREDICTED RACE</td><td>ERRROR</td><td>ERRROR %</td></tr>
...
double err1=0,err2=0,err3=0,err11=0,err22=0,err33=0;
    ...
    void disp()
    {
        ...
        //FileWriter fw=new FileWriter("w.csv");/
//BufferedWriter or= new BufferedWriter(fw);
        ...
        for(int i=0;i<3;i++)
{
    for(int j=0;j<3;j++)
    {
        //String s=new Double(inputweights[i][j]).toString();
        //or.write(s);
...
out.println("<tr><td>"+(i+1)+"</td><td>"+wt+"</td><td>"+h+"</td><td>"+g+"</td><td>"+race+"</td><td>"+ch+"</td><td>"+err+"</td><td>"+errp+"</td></tr>");
...
err=(r-o);
errp=Math.abs(err)*100;
out.println("<tr><td>"+i+"</td><td>"+wt+"</td><td>"+h+"</td><td>"+g+"</td><td>"+r+"</td><td>"+o+"</td><td>"+err+"</td><td>");%><font color="red"><%out.println(errp);%></font><%out.println("</td></tr>");
